    ...
    def LatVsFL(
        ...
        for h in arange(hlim[0], hlim[1] + hstp, hstp):
            gc, qc = pyapex.ApexFL().getFL(
                date=date, dlon=dlon, dlat=dlat, hateq=h, mlatRange=mlatlim, mlatSTP=mlatstp
            )
        ...
        stl, f107a, f107, ap = 17.0, 90, 90, [2, 2]
...
if __name__ == "__main__":
    ...
    def example1():
        Obj = HWM14_2DProf()
        Obj.LatVsFL(hlim=[80.0, 200.0], hstp=0.5, mlatlim=[-10.0, 10.0], mlatstp=0.1)
