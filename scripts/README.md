...
This directory contains example scripts and utilities demonstrating how to use pyHWM14 to retrieve wind values.
...
Command-line interface for retrieving wind values with flexible options.

**Usage:**
```bash
python scripts/retrieve.py --year 2023 --day 150 --time 12.0 --lat 40.0 --lon -105.0 --alt 300.0
```
