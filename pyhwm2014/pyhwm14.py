...
import pylab
from scipy import append, arange, ones, reshape, tile, transpose
...
class HWM142D:
    ...
    def HeiVsLTArray( self ):
        ...
        self.sltbins = arange( self.sltlim[ 0 ], self.sltlim[ 1 ] + self.sltstp, self.sltstp )
        ...
        for slt in self.sltbins:
            ...
            self.Uwind = Uwind if slt == self.sltlim[ 0 ] else append( self.Uwind, Uwind, axis=1 )
            self.Vwind = Vwind if slt == self.sltlim[ 0 ] else append( self.Vwind, Vwind, axis=1 )
